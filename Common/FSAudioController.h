...
@interface FSAudioController : NSObject {
    ...
    void (^_onRecordTrackAvailableBlock)(NSString *recordDirectory, NSString *recordFile, NSDictionary *metadata, BOOL finish);
    void (^_onRecordErrorBlock)(NSError *error);
